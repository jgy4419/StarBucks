...
tag.src = "https://youtube.com/iframe_api"; // script 태그를 가지고 있는 요소들 중에 제일 첫번째 요소를 지정

var firstScriptTag = document.getElementsByTagName('script')[0]; // 찾은 첫번째 요소에 부모 요소를 찾아서 무엇인가의 이전 부분에 삽입을 할 것인데 
  ...
  new YT.Player('player', {
    ...
    events: {
      onReady: function onReady(event) {
        // onReady라는 이벤트(명령)이 실행되면 다음과 같은 기능 실행
